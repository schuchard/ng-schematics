    ...
    >
      ...
      <div class="flex items-center px-6 lg:hidden">
        ...
        <div class="flex-shrink w-32 inline-block relative">
          ...
          <div
            class="pointer-events-none absolute right-0 top-0 h-full flex items-center px-2 text-grey"
          >
            <svg
    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full mb-6 lg:mb-0 lg:w-1/2 px-4 flex flex-col">
        ...
        >
          ...
          >
            <div class="w-2/5 xl:w-1/4 px-4 flex items-center">
              <div class="rounded-full bg-indigo-400 inline-flex mr-3">
                <svg
                  class="fill-current text-white h-8 w-8 block"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 32 32"
            ...
            <div
              class="hidden md:flex lg:hidden xl:flex w-1/4 px-4 items-center"
            >
              <div class="bg-indigo-400 h-2 w-2 rounded-full mr-2"></div>
              0%
            </div>
            <div class="flex w-3/5 md:w/12">
              <div class="w-1/2 px-4">
            ...
            <div class="text-center px-6 py-4">
              <div class="py-8">
                ...
                <div>
                  <button
                    type="button"
                    class="bg-blue-500 hover:bg-blue-800 text-white border border-blue-dark rounded px-6 py-4"
                  >
                    Buy now
                  </button>
                </div>
        ...
        <div class="md:flex md:flex-row-reverse items-center py-4">
          <div class="text-center mb-4 md:mb-0 md:flex">
            <div class="w-48 inline-block relative mb-4 md:mb-0 md:mr-4">
              ...
              <div
                class="pointer-events-none absolute pin-y pin-r right-0 top-0 h-full flex items-center px-2 text-grey"
              >
                <svg
                  class="fill-current h-4 w-4"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              <a
                href="#"
                class="inline-block leading-tight bg-blue-400 border border-blue-dark hover:bg-blue-800 px-3 py-2 text-white no-underline rounded"
                >Need help?</a
              >
            </div>
          </div>
