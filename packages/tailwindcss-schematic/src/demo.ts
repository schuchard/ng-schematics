          ...
          <div>
            <div class="text-center px-6 py-4">
              <div class="py-8">
                ...
                <div>
                  <button type="button" class="bg-blue-500 hover:bg-blue-800 text-white border border-blue-dark rounded px-6 py-4">Buy now</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="md:flex justify-between items-center text-sm">
        ...
        <div class="md:flex md:flex-row-reverse items-center py-4">
          <div class="text-center mb-4 md:mb-0 md:flex">
            ...
            <div>
              <a href="#" class="inline-block leading-tight bg-blue-400 border border-blue-dark hover:bg-blue-800 px-3 py-2 text-white no-underline rounded">Need help?</a>
            </div>
          </div>
